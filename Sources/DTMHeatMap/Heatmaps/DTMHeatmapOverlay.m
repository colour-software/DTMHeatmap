                                     ...
                                     atScale:(MKZoomScale)scale
{
    ...
    double adjustedScale = scale / 8; // The top scale values make the scale factor default to the max value so adjust to avoid that.
    ...
    double scaleFactor = x * slope + self.maxValue;
